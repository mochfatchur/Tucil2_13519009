...
# Program       : Bismillah Program Aplikasi Topology Sorting dengan Decrease and Conquer

# Fungsi Buka File Text dan Membuat List Adjacencynya
def makeListAdja():
    listAdjacency = []
    with open('../test/test5.txt', 'r') as file:
        for datas in file:
            listTemp = []
            stringTemp = ''
            data = datas.replace('\n','')
...
#print('\nMatrix Adjacency :')
#for data in AdjaMatrix:
#    print(data)
#print()

#for j in range(listLength(listVertex)):
#    print(dinV(j,AdjaMatrix))

print("Urutan Pengambilan Mata Kuliah (dari kiri ke kanan) berdasarkan Prequisitenya")
print(TopologicalSorting(listAdja,listVertex))
print()
Solusi = TopologicalSorting(listAdja,listVertex)
printSolusi(Solusi)
